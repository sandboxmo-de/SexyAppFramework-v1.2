...
public:
	...
	std::string				mDemoCommentStr;
	ulong					mDemoCommentDec;
	Buffer					mDemoBuffer;
	int						mDemoLength;
	int						mDemoPlayFrame;
	int						mLastDemoMouseX;
...
protected:	
	void					RehupFocus();
	void					ClearKeysDown();
	virtual bool			ProcessDeferredMessages(bool singleMessage);
	void					UpdateFTimeAcc();
...
public:
	...
	bool					ReadDemoBuffer(std::string &theError);
