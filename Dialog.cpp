...
{
	if (mHeaderFont == NULL)
		mHeaderFont = new SysFont(gSexyAppBase, "SansSerif", 14);
	if (mLinesFont == NULL)
		mLinesFont = new SysFont(gSexyAppBase, "SansSerif", 12);
}
...
void Dialog::MouseDown(int x, int y, int theClickCount)
{
	if (theClickCount == 1)
	{
...
void Dialog::MouseUp(int x, int y)
{
	if (mDragging)
	{
