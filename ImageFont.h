...
public:
	...
	virtual void			DrawStringEx(Graphics* g, int theX, int theY, const std::string& theString, 
								const Color& theColor, const Rect* theClipRect, RectList* theDrawnAreas, int* theWidth);
...
public:
	...
	virtual void			DrawString(Graphics* g, int theX, int theY, const std::string& theString, 
